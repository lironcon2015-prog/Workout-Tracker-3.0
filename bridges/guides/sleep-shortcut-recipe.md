...
> ⚠️ **מיושן — עדיף Health Auto Export.** הקיצור מסכם דגימות שינה **גולמיות** מ-HealthKit,
> ומכיוון שיש כמה מקורות (מספר שעונים + iPhone) עם דגימות חופפות, הסכום לא תואם את
> "Time Asleep" של אפליקציית Health (למשל Deep 60 במקום 29, זמן שינה 7:00 במקום 7:40).
...
שולח את נתוני הלילה שהסתיים לגשר (`bridges/health-nutrition-bridge.gs`), והאפליקציה
