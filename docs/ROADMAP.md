...
- **תוכנית שדרוג תזונה מפורטת (מסלול A, בהשראת Cronometer)** — טבעות אדהרנס, אמינות מקורות, סיבים/סוכר/נתרן: ראה `docs/NUTRITION_UPGRADE_PLAN.md` (📋 אופציונלי, גובש 07/2026; כולל בנספח את מסלולי B/C שלא נבחרו).
