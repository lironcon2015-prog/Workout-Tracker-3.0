...
| **אינטגרציית MyFitnessPal** | גשר Apps Script (`bridges/mfp-nutrition-bridge.gs`, JSONP), ייבוא תזונה מ-Gmail, כרטיס ממוצעים דינמי, גרפי קלוריות/חלבון, היסטוריה, 3 ייצואים | v15.59–15.76 |
...
- **תוכנית שדרוג תזונה מפורטת (מסלול A, בהשראת Cronometer)** — טבעות אדהרנס, אמינות מקורות, סיבים/סוכר/נתרן: ראה `docs/plans/NUTRITION_UPGRADE_PLAN.md` (📋 אופציונלי, גובש 07/2026; כולל בנספח את מסלולי B/C שלא נבחרו).
