...
|-----|-------|-------|--------|
| 0 | תשתית — `resolveBarcode` (cache-first → OFF) + OCR-on-miss | נמוך | ✅ Done (v16.62) |
| 1 | צמ"ת — גנריים עבריים מדויקים (**מקור חי CKAN**) | נמוך | ✅ Done (v16.61) |
| 2 | קטלוג שקיפות-מחירים — זיהוי ברקוד IL | בינוני | ⏸️ Deferred (אין API חי; ROI נמוך לחד-משתמש) |
| 4 | היוריסטיקת 729 | נמוך | ✅ Done (v16.62) |
