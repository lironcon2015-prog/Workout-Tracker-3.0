...
const ASSET_GALLERY_DATA = [
    ...
    // 20 התמונות החדשות מתוך Asset Gallery
...
// מיפוי לאחור על מנת לשמור על תאימות עם כל הפונקציות הקיימות בארכיון שמשתמשות במערך ה-URLs
