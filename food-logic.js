...
let _fdReturnToPortion = false;  // עורך המזון נפתח מתוך עורך המנה — חזרה אליו אחרי שמירה
let _fdReturnEntryId = null;     // רשומת היומן שהייתה פתוחה בעורך המנה (אם הייתה)
...
// אפס בבשר/דגים/חלב/שמן הוא אפס אמיתי (אין בהם סיבים), ולכן נספר ככיסוי מלא
// ולא כ"חסר" — זו ההבחנה שכל מנגנון הסיבים בנוי עליה.
...
const _BASIC_RAW = [
    ...
    { n: 'חזה עוף', k: 120, p: 23, c: 0, f: 2.6, fb: 0 },
    { n: 'שוקיים עוף', k: 172, p: 18, c: 0, f: 10.5, fb: 0 },
    { n: 'כרעיים עוף', k: 177, p: 18, c: 0, f: 11, fb: 0 },
    { n: 'שניצל עוף (נא)', k: 120, p: 23, c: 0, f: 2.6, fb: 0 },
    { n: 'חזה הודו', k: 115, p: 24, c: 0, f: 1.7, fb: 0 },
    { n: 'הודו טחון', k: 150, p: 21, c: 0, f: 7, fb: 0 },
    { n: 'בשר בקר טחון 5%', k: 137, p: 21, c: 0, f: 5, fb: 0 },
    { n: 'בשר בקר טחון 15%', k: 215, p: 18, c: 0, f: 15, fb: 0 },
    { n: 'אנטריקוט בקר', k: 250, p: 19, c: 0, f: 19, fb: 0 },
    { n: 'סלמון', k: 208, p: 20, c: 0, f: 13, fb: 0 },
    { n: 'טונה (טרי)', k: 130, p: 28, c: 0, f: 1, fb: 0 },
    { n: 'טונה בשימור במים', k: 116, p: 26, c: 0, f: 1, fb: 0 },
    { n: 'ביצה', k: 143, p: 13, c: 1.1, f: 9.5, fb: 0, s: [{ label: 'ביצה (M, 50 ג\')', grams: 50 }] },
    { n: 'חלבון ביצה', k: 52, p: 11, c: 0.7, f: 0.2, fb: 0, s: [{ label: 'חלבון אחד (33 ג\')', grams: 33 }] },
    // חלב ומוצריו
    { n: 'חלב 3%', k: 60, p: 3.3, c: 4.7, f: 3, fb: 0, s: [{ label: 'כוס (240 מ"ל)', grams: 240 }] },
    { n: 'חלב 1%', k: 42, p: 3.4, c: 5, f: 1, fb: 0, s: [{ label: 'כוס (240 מ"ל)', grams: 240 }] },
    { n: 'יוגורט טבעי', k: 61, p: 3.5, c: 4.7, f: 3.3, fb: 0 },
    { n: 'גבינה לבנה 5%', k: 90, p: 10, c: 4, f: 5, fb: 0 },
    { n: 'גבינה לבנה 3%', k: 70, p: 10, c: 4, f: 3, fb: 0 },
    { n: 'קוטג\' 5%', k: 98, p: 11, c: 3, f: 5, fb: 0 },
    { n: 'גבינה צהובה', k: 350, p: 25, c: 2, f: 27, fb: 0 },
    { n: 'גבינת בולגרית 5%', k: 100, p: 13, c: 4, f: 5, fb: 0 },
    // פחמימות / דגנים (מבושל אלא אם צוין)
    { n: 'אורז לבן (מבושל)', k: 130, p: 2.7, c: 28, f: 0.3, fb: 0.4, s: [{ label: 'כוס (158 ג\')', grams: 158 }] },
    { n: 'אורז מלא (מבושל)', k: 112, p: 2.6, c: 24, f: 0.9, fb: 1.8 },
    { n: 'פסטה (מבושלת)', k: 131, p: 5, c: 25, f: 1.1, fb: 1.8 },
    { n: 'קוסקוס (מבושל)', k: 112, p: 3.8, c: 23, f: 0.2, fb: 1.4 },
    { n: 'קינואה (מבושלת)', k: 120, p: 4.4, c: 21, f: 1.9, fb: 2.8 },
    { n: 'שיבולת שועל (יבש)', k: 389, p: 17, c: 66, f: 7, fb: 10.6 },
    { n: 'תפוח אדמה (מבושל)', k: 87, p: 2, c: 20, f: 0.1, fb: 1.8 },
    { n: 'בטטה', k: 86, p: 1.6, c: 20, f: 0.1, fb: 3 },
    { n: 'לחם לבן', k: 265, p: 9, c: 49, f: 3.2, fb: 2.7, s: [{ label: 'פרוסה (28 ג\')', grams: 28 }] },
    { n: 'לחם מלא', k: 247, p: 13, c: 41, f: 3.4, fb: 6.8, s: [{ label: 'פרוסה (32 ג\')', grams: 32 }] },
    // קטניות
    { n: 'עדשים (מבושל)', k: 116, p: 9, c: 20, f: 0.4, fb: 7.9 },
    { n: 'חומוס גרגרים (מבושל)', k: 164, p: 9, c: 27, f: 2.6, fb: 7.6 },
    { n: 'שעועית לבנה (מבושל)', k: 127, p: 9, c: 23, f: 0.5, fb: 6.3 },
    { n: 'טופו', k: 76, p: 8, c: 1.9, f: 4.8, fb: 0.3 },
    { n: 'אדממה', k: 121, p: 12, c: 9, f: 5, fb: 5.2 },
    // ירקות (נא)
    { n: 'מלפפון', k: 15, p: 0.7, c: 3.6, f: 0.1, fb: 0.5 },
    { n: 'עגבנייה', k: 18, p: 0.9, c: 3.9, f: 0.2, fb: 1.2 },
    { n: 'חסה', k: 15, p: 1.4, c: 2.9, f: 0.2, fb: 1.3 },
    { n: 'גזר', k: 41, p: 0.9, c: 10, f: 0.2, fb: 2.8 },
    { n: 'בצל', k: 40, p: 1.1, c: 9, f: 0.1, fb: 1.7 },
    { n: 'פלפל אדום', k: 31, p: 1, c: 6, f: 0.3, fb: 2.1 },
    { n: 'ברוקולי', k: 34, p: 2.8, c: 7, f: 0.4, fb: 2.6 },
    { n: 'כרובית', k: 25, p: 1.9, c: 5, f: 0.3, fb: 2 },
    { n: 'קישוא', k: 17, p: 1.2, c: 3.1, f: 0.3, fb: 1 },
    { n: 'חציל', k: 25, p: 1, c: 6, f: 0.2, fb: 3 },
    { n: 'תרד', k: 23, p: 2.9, c: 3.6, f: 0.4, fb: 2.2 },
    { n: 'פטריות', k: 22, p: 3.1, c: 3.3, f: 0.3, fb: 1 },
    { n: 'אבוקדו', k: 160, p: 2, c: 9, f: 15, fb: 6.7, s: [{ label: 'חצי בינוני (100 ג\')', grams: 100 }] },
    // פירות
    { n: 'תפוח', k: 52, p: 0.3, c: 14, f: 0.2, fb: 2.4, s: [{ label: 'בינוני (180 ג\')', grams: 180 }] },
    { n: 'בננה', k: 89, p: 1.1, c: 23, f: 0.3, fb: 2.6, s: [{ label: 'בינונית (118 ג\')', grams: 118 }] },
    { n: 'תפוז', k: 47, p: 0.9, c: 12, f: 0.1, fb: 2.4 },
    { n: 'ענבים', k: 69, p: 0.7, c: 18, f: 0.2, fb: 0.9 },
    { n: 'תות', k: 32, p: 0.7, c: 7.7, f: 0.3, fb: 2 },
    { n: 'אבטיח', k: 30, p: 0.6, c: 8, f: 0.2, fb: 0.4 },
    { n: 'מלון', k: 34, p: 0.8, c: 8, f: 0.2, fb: 0.9 },
    { n: 'אגס', k: 57, p: 0.4, c: 15, f: 0.1, fb: 3.1 },
    { n: 'תמר', k: 282, p: 2.5, c: 75, f: 0.4, fb: 8, s: [{ label: 'תמר אחד (24 ג\')', grams: 24 }] },
    // אגוזים / שמנים / ממרחים
    { n: 'שקדים', k: 579, p: 21, c: 22, f: 50, fb: 12.5 },
    { n: 'אגוזי מלך', k: 654, p: 15, c: 14, f: 65, fb: 6.7 },
    { n: 'בוטנים', k: 567, p: 26, c: 16, f: 49, fb: 8.5 },
    { n: 'חמאת בוטנים', k: 588, p: 25, c: 20, f: 50, fb: 6, s: [{ label: 'כף (16 ג\')', grams: 16 }] },
    { n: 'טחינה גולמית', k: 595, p: 17, c: 21, f: 53, fb: 9.3, s: [{ label: 'כף (15 ג\')', grams: 15 }] },
    { n: 'שמן זית', k: 884, p: 0, c: 0, f: 100, fb: 0, s: [{ label: 'כף (14 ג\')', grams: 14 }] },
    { n: 'חמאה', k: 717, p: 0.9, c: 0.1, f: 81, fb: 0, s: [{ label: 'כף (14 ג\')', grams: 14 }] },
    { n: 'דבש', k: 304, p: 0.3, c: 82, f: 0, fb: 0.2, s: [{ label: 'כף (21 ג\')', grams: 21 }] },
    { n: 'סוכר', k: 387, p: 0, c: 100, f: 0, fb: 0, s: [{ label: 'כפית (4 ג\')', grams: 4 }] }
];
const BASIC_FOODS = _BASIC_RAW.map((x, i) => ({
    id: 'basic:' + i,
    name: x.n, brand: 'חומר גלם', barcode: null, source: 'basic',
    per100: { kcal: x.k, p: x.p, c: x.c, f: x.f, fb: x.fb },
...
function _fdOpenPortion(food, entry) {
    ...
    // עריכת ערכי המוצר זמינה כבר כאן (סרוק/OFF/מותאם) — בלי לעבור דרך טאב "אחרונים"
    const canEditFood = food.source === 'gemini' || food.source === 'off' || food.source === 'custom';
    body.innerHTML = `
        ...
        ${canEditFood ? `<button type="button" class="fd-edit-food-btn" onclick="fdEditFromPortion()"><span class="material-symbols-outlined">edit</span>עריכת ערכי המוצר</button>` : ''}
    ...
    sheet.classList.add('open');
    _fdUpdatePreview();
    _fdBackfillFiber(food);
}

// _fdBackfillFiber — השלמת סיבים למזון מהקאש שנשמר לפני שהשדה היה קיים.
// הטאבים "אחרונים"/"מועדפים" קוראים ישירות מ-KEY_FOOD_DB ואינם עוברים ברשת, ולכן
...
function _fdCustomUnitChanged() {
    ...
    const extra = document.getElementById('fd-c-unit-extra');
    if (extra && sel) extra.style.display = sel.value === 'unit' ? 'block' : 'none';
}
...
function _fdShowCustomFoodForm(food) {
    ...
    _fdReturnToPortion = false;   // מאותחל כאן; fdEditFromPortion מדליק מחדש אחרי הקריאה
    _fdReturnEntryId = null;
    ...
    const isOff = editMode && food.source === 'off';
    const storedUnit = editMode ? (food.baseUnit || 'g') : 'g';
    const hasUnitW = editMode && Number(food.unitGrams) > 0;
    // מצב "יחידה" בטופס: מזון unit ותיק (טריק ×100) או מזון עם משקל יחידה מוגדר (per100 אמיתי + serving)
    const baseUnit = (storedUnit === 'unit' || hasUnitW) ? 'unit' : storedUnit;
    const p = editMode ? (food.per100 || {}) : {};
    // הצגה ליחידה: טריק ×100 → חלוקה ב-100; משקל יחידה ידוע → per100 אמיתי × משקל/100
    const factor = storedUnit === 'unit' ? 0.01 : hasUnitW ? Number(food.unitGrams) / 100 : 1;
    const vKcal = editMode ? _fdR((p.kcal || 0) * factor) : '';
    ...
    body.innerHTML = `
        ...
        <label class="fd-field fd-field--full"><span>יחידת מידה</span>
            <select id="fd-c-unit" onchange="_fdCustomUnitChanged()">
                ...
                <option value="unit" ${baseUnit === 'unit' ? 'selected' : ''}>יחידה</option>
            </select>
        </label>
        <div id="fd-c-unit-extra" style="display:${baseUnit === 'unit' ? 'block' : 'none'}">
            <div class="fd-portion-row">
                <label class="fd-field"><span>שם היחידה</span><input type="text" id="fd-c-unit-name" value="${_fdEsc(vUnitName)}" maxlength="30" placeholder="סקופ / פרוסה / כף"></label>
                <label class="fd-field"><span>משקל יחידה בגרמים</span><input type="number" id="fd-c-unit-grams" inputmode="decimal" min="0" step="any" value="${vUnitGrams}" placeholder="אופציונלי"></label>
            </div>
            <small class="fd-unit-hint">בהזנת משקל, ערכי 100 גרם יחושבו אוטומטית ויתאפשר תיעוד גם לפי גרמים</small>
        </div>
        <div class="fd-portion-row">
...
// עריכת המוצר מתוך עורך המנה — פותח את עורך המזון המלא, ואחרי שמירה חוזר לעורך המנה
function fdEditFromPortion() {
    const f = _fdSelectedFood;
    if (!f) return;
    // איתור רשומת המאגר (id / ברקוד / שם+מקור); אם אינה קיימת — נוצרת, כדי שהתיקון יישמר לסריקות עתידיות
    const db = StorageManager.getFoodDb();
    let rec = db.find(x => x.id === f.id || (x.barcode && f.barcode && x.barcode === f.barcode))
        || db.find(x => x.name === f.name && x.source === f.source);
    if (!rec) {
        rec = {
            id: f.id, name: f.name, brand: f.brand || '', barcode: f.barcode || null,
            source: f.source || 'off', per100: f.per100, servings: f.servings, baseUnit: f.baseUnit || 'g'
        };
        StorageManager.upsertFoodToDb(rec);
    }
    const entryId = _fdEditEntryId;   // נשמר לפני שהטופס מאפס אותו
    _fdShowCustomFoodForm(rec);
    _fdReturnToPortion = true;
    _fdReturnEntryId = entryId;
}
...
function fdSaveCustomFood(logAfter) {
    ...
    const unitGrams = unit === 'unit' ? (_fdNum(unitGramsEl && unitGramsEl.value) || 0) : 0;
    let per100, servings, baseUnit;
    if (unit === 'unit' && unitGrams > 0) {
    ...
    // unitName/unitGrams נשמרים על המזון כדי שעריכה חוזרת תציג שוב ערכים ליחידה; מתאפסים במעבר לגרם/מ"ל
    const unitMeta = unit === 'unit'
        ? { unitName: unitName || null, unitGrams: unitGrams > 0 ? unitGrams : null }
    ...
    if (_fdEditCustomFoodId) {
        ...
        // edited=true מסמן מוצר חיצוני (off/gemini) שתוקן ידנית — מציג אותו בטאב "מותאמים"
        const food = Object.assign({ id: _fdEditCustomFoodId, name, source: _fdEditCustomFoodSrc || 'custom', per100, servings, baseUnit, edited: true }, unitMeta);
        StorageManager.upsertFoodToDb(food);
        const savedId = _fdEditCustomFoodId;
        _fdEditCustomFoodId = null;
        _fdEditCustomFoodSrc = null;
        _fdSyncCloud();
        haptic('medium');
        // אם העריכה נפתחה מתוך עורך המנה — חזרה אליו עם הערכים המתוקנים (אותו sheet, רינדור מחדש)
        if (_fdReturnToPortion) {
            _fdReturnToPortion = false;
            const entryId = _fdReturnEntryId;
            _fdReturnEntryId = null;
            const updated = StorageManager.getFoodDb().find(f => f.id === savedId);
            const entry = entryId ? StorageManager.getFoodLogDay(_fdDate).find(e => e.id === entryId) : null;
            if (updated) { fdRenderTab(); _fdOpenPortion(updated, entry || null); return; }
        }
        closeFoodPortion();
        fdRenderTab();
        return;
